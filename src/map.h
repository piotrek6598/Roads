 ...
 * Usuwa drogę krajową o danym numerze. Jeśli droga o podanym numerze nie istnieje
 * lub numer jest niepoprawny nie dokonuje żadnych zmian w mapie dróg.
 * Nie usuwa dróg ani miast.
 * @param[in,out] map    - wskaźnik na strukturę przechowującą mapę dróg;
 * @param[in] routeId    - numer drogi krajowej.
 * @return Wartość @p true, jeśli droga krajowa o podanym numerze została usunięta.
 * Wartość @p false, jeśli droga krajowa o podanym numerze nie istnieje
 * lub numer jest niepoprawny.
 */
